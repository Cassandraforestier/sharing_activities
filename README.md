# Sharing Activities
<p align="center">
  <img width="150" height="150" src="frontend/assets/logo.png" />
</p>
...
US#7 : Feature supplémentaire : ajouter des notifications | <ul><li>- [x] Page « détail d'une activité » : lors d'un clic pour l'ajout d'une activité au panier, 2 snackbars :<ul><li> "votre activité a été ajouté au panier !" en vert -> redirige vers la liste des activités</li><li>"Vous avez déjà ajouté cette activité au panier" - en rouge</li></ul></li><li>- [x] Page de connexion, une snackbar : "Vos indentifiants sont incorrects, veuillez réessayer" - en rouge</li><li>- [x] Page du panier : lors de la suppression d'une activité : 1 snackbar orange : "Activité supprimée du panier"</li><li>- [x] Page "profil" : 1 snackbar lors de la validation : "Vos données ont été enregistrées" - en vert</li><li>- [x] Chaque validation/modification à sa snackbar d'erreur en rouge avec un message d'erreur.</li></ul> | :x: | :heavy_check_mark: 
